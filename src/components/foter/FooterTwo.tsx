    ...
    <div className=" flex w-[100%] md:w-[50%] mt-[20px] md:m-0 ">
      <div className=" w-[70%] md-[50%] ">
        ...
        <div className=" flex gap-[10px] items-center ">
          <Image width={16} height={16} alt="phone" src="/iconImg/Vector.png" />
          <div>
      ...
      <div>
        <div className=" text-white text-[14px] mb-[10px] ">Follow us</div>
        <div className=" md:flex md:gap-[10px] flex flex-col gap-[20px] ">
          ...
          <a
            href="https://www.youtube.com/watch?v=CQinsuKbGRk&list=RDMM&index=10 "
